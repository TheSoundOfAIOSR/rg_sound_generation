...
class F0LoudnessGenerator:
    ...
    def _load_model(self):
        ...
        _input = concatenate([_instrument_source, _qualities, _latent_sample, _velocity, _pitch], axis=-1,
                             name='concat_1')
        ...
        self.model = tf.keras.models.Model([_instrument_source, _qualities, _latent_sample, _velocity, _pitch],
