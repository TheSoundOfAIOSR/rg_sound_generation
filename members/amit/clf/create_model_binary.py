...
def create_rnn_model(conf: Dict, input_shapes, show_summary: bool = False) -> tf.keras.Model:
    input_shape = input_shapes["spec"]

    input_ = Input(shape=input_shape, name="spec")
    x = tf.keras.layers.Reshape(input_shape[::-1])(input_)
