...
class TFRecordProvider(data.RecordProvider):
    ...
    def get_dataset(self, shuffle=True):
        ...
        dataset = dataset.map(parse_tfexample, num_parallel_calls=tf.data.experimental.AUTOTUNE)
        return dataset
...
class PartialTFRecordProvider(TFRecordProvider):
    ...
    def __init__(
        ...
        super().__init__(file_pattern, example_secs, sample_rate, frame_rate, map_func)
